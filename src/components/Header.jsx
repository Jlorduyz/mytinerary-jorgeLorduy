...
function Login() {
    ...
    const dispatch = useDispatch();
    return (
        <>{token ? <Link to={'/'} onClick={()=>dispatch(logOut())} className="shadow-xl hover:shadow-lg transition duration-300 h-10 w-auto px-2 p-1 rounded-lg border 2 border-indigo-700"><p className="flex items-center gap-3 font-semibold text-2xl text-white hover:text-rose-400">LOG OUT<span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
            <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1" />
        </svg></span></p></Link> : <Link to={'/log'} className="shadow-xl hover:shadow-lg transition duration-300 h-10 w-auto px-2 p-1 rounded-lg border 2 border-indigo-700"><p className="flex items-center gap-3 font-semibold text-2xl text-white hover:text-rose-400">LOG IN<span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
            <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1" />
        </svg></span></p></Link>} </>)
}
